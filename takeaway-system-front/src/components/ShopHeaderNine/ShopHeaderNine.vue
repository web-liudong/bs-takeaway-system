    ...
    <a class="back" @click="$router.back()">
      <i class="iconfont icon-arrow_left"></i>
       ...
       <div class="shop-content" @click="toggleShopShow">
         <img class="content-image" src="../ShopHeaderNine/images/10.png" style="border:5px solid white">
         <div class="header-content">
           <h2 class="content-title">
             <span class="content-tag">
               <span class="mini-tag">品牌</span>
             </span> <span class="content-name">麻辣小龙虾</span>
                   ...
                   <div class="brief-modal-content">
                     <h2 class="content-title">
                       <span class="content-tag">
                         ...
                         <span class="content-name">麻辣小龙虾</span> </h2>
                     ...
                     <p>配送费用</p>
                       ...
                       <p>距离</p> </li> </ul>
                        <h3 class="brief-modal-title"><span>公告</span>
                           ...
                           是以小龙虾为特色的中式营养快餐，自 2019 年 10 月 18 日创立“麻辣小龙虾”品牌至今 </div>
