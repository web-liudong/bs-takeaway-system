    ...
    <a class="back" @click="$router.back()">
      <i class="iconfont icon-arrow_left"></i>
       ...
       <div class="shop-content" @click="toggleShopShow">
         <img class="content-image" src="../ShopHeaderSeven/images/8.png" style="border:5px solid white">
         <div class="header-content">
           <h2 class="content-title">
             <span class="content-tag">
               <span class="mini-tag">品牌</span>
             </span> <span class="content-name">傻四肉饼</span>
                   ...
                   <div class="brief-modal-content">
                     <h2 class="content-title">
                       <span class="content-tag">
                         ...
                         <span class="content-name">傻四肉饼</span> </h2>
                     ...
                     <p>配送费用</p>
                       ...
                       <p>距离</p> </li> </ul>
                        <h3 class="brief-modal-title"><span>公告</span>
                           ...
                           是以肉饼为特色的中式营养快餐，自 2016 年 1 月 8 日创立“傻四肉饼”品牌至今 </div>
